...
function UserNavbar() {
  ...
  if (!user) {
    return (
      <div className="bg-gray-900 border-b border-gray-700 px-6 py-4 flex items-center justify-between">
        <div className="text-gray-300 font-semibold">⌨️uChat🤖</div>
  ...
  return (
    <div className="bg-blue-1000 border-b border-gray-700 px-6 py-2 flex items-center justify-between">
      <div className="text-gray-300 text-4xl font-bold">⌨️uChat🤖</div>
